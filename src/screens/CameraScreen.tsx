...
import { CrazyCameraView } from '../components/CrazyCameraView';
import { PhotoComposerView } from '../components/PhotoComposerView';
...
type AndroidProps = Pick<Props, 'navigation'>;

function AndroidCameraContent({ navigation }: AndroidProps) {
